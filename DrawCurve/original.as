...
package {
    ...
    public class Take02 extends Sprite {
        private const POINT_COUNT:uint = 5;
        private const ANGLE:Number = 360/POINT_COUNT;
        ...
        public function Take02():void {
            drawStage = new Shape();
            addChild(drawStage);
            for (var i:uint = 0; i < POINT_COUNT; i++) {
        ...
        public function drawLine():void {
            ...
            for (var i:uint = 0; i < POINT_COUNT; i++) {
                var pA:uint = (i+POINT_COUNT)%POINT_COUNT;
                var pB:uint = (pA+1)%POINT_COUNT;
                var pC:uint = (pB+1)%POINT_COUNT;
                var pD:uint = (pC+1)%POINT_COUNT;
