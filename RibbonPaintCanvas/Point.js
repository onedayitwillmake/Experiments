...
(function() {
     ...
     * @constructor
     */
	Sketch.Point = function(xpos, ypos) {
		this.x = xpos || 0;
		this.y = ypos || 0;
		return this;
	};

	Sketch.Point.prototype = {
		x:	0,
		y: 	0,
        ...
        /**
         * Create a new Sketch.Point equal to this one.
         * @return {Sketch.Point}
         */
        clone : function() {
            var p = new Sketch.Point();
            p.set( this.x, this.y );
            return p;
        },
        /**
		...
		getAngleBetween: function( point ) {
		...
		isEqual: function( point ) {
			return Math.abs(this.x - point.x) < 0.1 && Math.abs(this.y-point.y) < 0.1
		},
	...
	Sketch.Point.prototype.ZERO = new Sketch.Point(0,0);
})();